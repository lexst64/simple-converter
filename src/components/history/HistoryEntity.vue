...
<template>
  ...
  >
    <div class="min-w-0 flex-1">
      <p class="font-medium truncate text-slate-800 dark:text-slate-100">{{ props.item.fileName }}</p>
    ...
    <div class="flex gap-2 justify-end">
      <div class="flex shrink-0 items-center gap-2 text-sm">
        <SmallBadge class="hidden bg-blue-100 text-blue-800 ring-blue-200 dark:bg-blue-950/80 dark:text-blue-300 dark:ring-blue-800 md:inline-flex">
          {{ props.item.initialFormat.toUpperCase() || 'unknown' }}
        </SmallBadge>
        <ArrowLongRight class="text-blue-500 dark:text-indigo-400" />
        <SmallBadge class="bg-blue-100 text-blue-800 ring-blue-200 dark:bg-blue-950/80 dark:text-blue-300 dark:ring-blue-800">
